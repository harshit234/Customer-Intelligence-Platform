"""
build_index.py â€” Build FAISS vector index from CFPB complaint narratives.
Usage:
    python src/rag/build_index.py --sample-size 1000
"""
import argparse
import json
...
def main() -> None:
    ...
    print(f"\n{'='*55}")
    print("  Building FAISS Index â€” CFPB Complaints")
    print(f"{'='*55}")
